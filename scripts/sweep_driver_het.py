...
def main():
    ...
    parser.add_argument('--het-sigma', type=float, default=0.10,
                        help='Per-neuron conductance heterogeneity (fractional std)')
    ...
    print("\nBuilding simulator...")
    simulator, base_state, _ = build_simulator(het_sigma=args.het_sigma)
